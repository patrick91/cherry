...
public enum CherryControlRequest: Codable, Equatable, Sendable {
    ...
    case openBrowser(OpenBrowserRequest)
    case closeBrowser
    case selectBrowser(SelectBrowserRequest)
    case openBrowserTab(OpenBrowserTabRequest)
    case closeBrowserTab(BrowserTabRequest)
    case selectBrowserTab(BrowserTabRequest)
    case browserNavigate(BrowserNavigateRequest)
    case browserBack(BrowserTabRequest)
    case browserForward(BrowserTabRequest)
    case browserReload(BrowserTabRequest)
    case browserWait(BrowserWaitRequest)
    case browserSnapshot(BrowserSnapshotRequest)
    case browserScreenshot(BrowserTabRequest)
    case browserClick(BrowserClickRequest)
    case browserType(BrowserTypeRequest)
    case browserPress(BrowserPressRequest)
    case browserScroll(BrowserScrollRequest)
    case browserEvaluate(BrowserEvaluateRequest)
    case listTerminals
    case listAgents
    case listNotes
    case listTodos
...
public enum BrowserPlacement: String, Codable, Equatable, Sendable {
    case splitRight = "split_right"
    case standalone
}

public struct OpenBrowserRequest: Codable, Equatable, Sendable {
...
public struct SelectBrowserRequest: Codable, Equatable, Sendable {
    public let placement: BrowserPlacement

    public init(placement: BrowserPlacement) {
        self.placement = placement
    }
}

public struct OpenBrowserTabRequest: Codable, Equatable, Sendable {
    public let url: String?
...
public struct BrowserTabRequest: Codable, Equatable, Sendable {
...
public struct BrowserNavigateRequest: Codable, Equatable, Sendable {
    public let tabID: String?
    public let url: String

    public init(tabID: String? = nil, url: String) {
        self.tabID = tabID
        self.url = url
    }
}

public struct BrowserWaitRequest: Codable, Equatable, Sendable {
    public let tabID: String?
    public let timeoutMilliseconds: Int?

    public init(tabID: String? = nil, timeoutMilliseconds: Int? = nil) {
        self.tabID = tabID
        self.timeoutMilliseconds = timeoutMilliseconds
    }
}

public struct BrowserSnapshotRequest: Codable, Equatable, Sendable {
    public let tabID: String?
...
public struct BrowserClickRequest: Codable, Equatable, Sendable {
    public let tabID: String?
    public let elementRef: String

    public init(tabID: String? = nil, elementRef: String) {
        self.tabID = tabID
        self.elementRef = elementRef
    }
}

public struct BrowserTypeRequest: Codable, Equatable, Sendable {
    public let tabID: String?
    public let elementRef: String
    public let text: String
    public let clear: Bool?

    public init(tabID: String? = nil, elementRef: String, text: String, clear: Bool? = nil) {
        self.tabID = tabID
        self.elementRef = elementRef
        self.text = text
        self.clear = clear
...
public struct BrowserPressRequest: Codable, Equatable, Sendable {
    public let tabID: String?
    public let key: String
    public let modifiers: [String]?

    public init(tabID: String? = nil, key: String, modifiers: [String]? = nil) {
        self.tabID = tabID
        self.key = key
...
public struct BrowserScrollRequest: Codable, Equatable, Sendable {
    public let tabID: String?
    public let deltaX: Int?
    public let deltaY: Int?

    public init(tabID: String? = nil, deltaX: Int? = nil, deltaY: Int? = nil) {
        self.tabID = tabID
        self.deltaX = deltaX
        self.deltaY = deltaY
    }
...
public struct BrowserEvaluateRequest: Codable, Equatable, Sendable {
    public let tabID: String?
    public let script: String
    public let arguments: [String: BrowserJSONValue]?

    public init(
        tabID: String? = nil,
        script: String,
        arguments: [String: BrowserJSONValue]? = nil
    ) {
        self.tabID = tabID
        self.script = script
...
public indirect enum BrowserJSONValue: Codable, Equatable, Sendable {
    case null
    case bool(Bool)
    case int(Int)
    case double(Double)
    ...
    public init(from decoder: Decoder) throws {
        ...
        if container.decodeNil() {
            ...
            self = .array(value)
        } else if let value = try? container.decode([String: BrowserJSONValue].self) {
            self = .object(value)
        } else {
            throw DecodingError.dataCorruptedError(
                in: container,
                debugDescription: "Unsupported browser JSON value."
            )
        }
    }
...
public enum CherryControlResult: Codable, Equatable, Sendable {
    ...
    case getBrowserStatus(BrowserStatusResult)
    case openBrowser(BrowserActionResult)
    case closeBrowser(BrowserActionResult)
    case selectBrowser(BrowserActionResult)
    case openBrowserTab(BrowserActionResult)
    case closeBrowserTab(BrowserActionResult)
    case selectBrowserTab(BrowserActionResult)
    case browserNavigate(BrowserActionResult)
    case browserBack(BrowserActionResult)
    case browserForward(BrowserActionResult)
    case browserReload(BrowserActionResult)
    case browserWait(BrowserActionResult)
    case browserSnapshot(BrowserSnapshotResult)
    case browserScreenshot(BrowserScreenshotResult)
    case browserClick(BrowserActionResult)
    case browserType(BrowserActionResult)
    case browserPress(BrowserActionResult)
    case browserScroll(BrowserActionResult)
    case browserEvaluate(BrowserEvaluateResult)
...
public struct BrowserStatusResult: Codable, Equatable, Sendable {
...
public struct BrowserActionResult: Codable, Equatable, Sendable {
    public let browser: BrowserStatusResult
    public let tab: BrowserTabInfo?

    public init(browser: BrowserStatusResult, tab: BrowserTabInfo? = nil) {
        self.browser = browser
        self.tab = tab
    }
}

public struct BrowserSnapshotElement: Codable, Equatable, Sendable {
...
public struct BrowserSnapshotResult: Codable, Equatable, Sendable {
    ...
    public let elements: [BrowserSnapshotElement]
    public let text: String
...
public struct BrowserEvaluateResult: Codable, Equatable, Sendable {
    public let tabID: String
    public let url: String?
    public let title: String
    public let value: BrowserJSONValue

    public init(tabID: String, url: String?, title: String, value: BrowserJSONValue) {
        self.tabID = tabID
        self.url = url
        self.title = title
        self.value = value
